...
def connect_db():
    conn = psycopg2.connect(dbname="pokemons", user="postgres", password="root", host="localhost", port="5432") #psycopg2.connect("dbname=concurrente user=postgres password=steven@555")
    #cur = conn.cursor()
    return conn
